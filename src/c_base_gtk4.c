...
GtkWidget* create_c_base_page(GtkWidget *main_stack, GtkWidget *back_home) {    
    ...
    gtk_box_append(GTK_BOX(c_base_h), c_base_v1); gtk_box_append(GTK_BOX(c_base_h), c_base_v2); gtk_box_append(GTK_BOX(c_base_h), c_base_v3);
    ...
    gtk_widget_set_size_request(
        c_base_h,
        TEXT_BUTTON_SIZE_W * 3 - EDGE_SPACING,
        TEXT_BUTTON_SIZE_H * 3 - EDGE_SPACING
    );
